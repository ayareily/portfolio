      ...
      <h3 class="text-center mt-3">触ってきた技術たち</h3>
        <div class="row justify-content-center" id="profileskills">
          ...
          <div class="card col-md-10 m-2">
            ...
            <a class="d-flex align-items-end" href="{{ route('tags.show', ['name' => 'CSS']) }}">
            <i class="si far fa-file-code fa-2x mr-2"></i>CSS</a>
            </li>
            ...
            <a class="d-flex align-items-end" href="{{ route('tags.show', ['name' => 'PC修理']) }}">
            <i class="si fas fa-wrench fa-2x mr-2"></i>PC Repair</p>
            </li>

            <li class="list-group-item">
            <h5 class="list-group-item-heading">2019.10</h5>
            <a class="d-flex align-items-end" href="{{ route('tags.show', ['name' => 'GAS']) }}">
            <i class="si fab fa-google fa-2x mr-2"></i>GAS</p>
            </li>
            
            <li class="list-group-item">
            <h5 class="list-group-item-heading">2020.2</h5>
            <a class="d-flex align-items-end" href="{{ route('tags.show', ['name' => 'JavaScript']) }}">
            <i class="si fab fa-js-square fa-2x mr-2"></i>JavaScript</p>
            </li>

            <li class="list-group-item">
            <h5 class="list-group-item-heading">2020.3</h5>
            <a class="d-flex align-items-end" href="{{ route('tags.show', ['name' => 'PHP']) }}">
            <i class="si fab fa-php fa-2x mr-2"></i>PHP</p>
            </ul>
