...
@section('content')
  @include('nav')
  <div class="container-fluid justify-content-center " style="background-color: #FDEDFB;">
        ...
        <div class="row justify-content-center">
          <div class="col-md-5 m-2">
            <div class="card-body text-center">
              ...
              <i class="fas fa-music fa-3x pb-3"></i>
          ...
          <div class="col-md-5 m-2">
            <div class="card-body text-center">
              <h5 class="card-title">WEBページ制作</h5>
              <i class="fas fa-book-reader fa-3x pb-3"></i>
              <h6 class="card-subtitle mb-2 text-muted">ホームページビルダー（先方のご希望）</h6>
            </div>
          </div>
        </div>
  </div>
